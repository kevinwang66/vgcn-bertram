...
parser.add_argument('--model_path', type=str, default="exp_bertram+vgcnbert_50%/vgcn_classifier+bertram.pth", help='Path to the saved model checkpoint')
...
file_path = 'exp_bertram+vgcnbert_50%/data-50%r/processed_rare_words_with_contexts_400k_th=20_maxctx=5.json'
words_with_contexts = load_rare_words(file_path)
bertram.add_word_vectors_to_model(words_with_contexts, tokenizer, vgcn_bert_instance)
