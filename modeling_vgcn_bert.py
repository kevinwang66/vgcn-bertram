...
# Copied from transformers.models.distilbert.modeling_distilbert.DistilBertaedModel with DistilBert->VGCNBert,distilbert->vgcn_bert
...
class VGCNBertModel(VGCNBertPreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs = self.transformer(
            hidden_states=embeddings,  # 传入 VGCN 的嵌入结果
